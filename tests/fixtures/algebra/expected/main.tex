...
\begin{center}
\begin{tikzcd}
{} \arrow[r, "{start}"] & {q}_{0} \arrow[r, "{b}"] \arrow[rr, "{a}"] & {q}_{1} \arrow[r, "{c}"] \arrow[loop above, "{b}"] & {q}_{2}
\end{tikzcd}
\end{center}
...
\begin{center}
\begin{tikzcd}
{q}_{0} \arrow[r, "{a}"] & {q}_{1} \arrow[r, "{a}"] & {q}_{2} \arrow[r, "{a}"] & {q}_{3} \arrow[lll, "{a}"]
\end{tikzcd}
\end{center}
...
\begin{center}
\begin{tikzcd}
{\mathsf{DA}}_{\mathcal{L}} \arrow[r, "{\overline{2}}"] \arrow[r, "{\perp}"] \arrow[r, "{{\overline{2}}^{\mathsf{op}}}"'] \arrow[d, "{U}"] & {{\mathsf{DA}}_{\mathsf{rev}\left( \mathcal{L} \right)}}^{\mathsf{op}} \arrow[d, "{U}"] \\
\mathbf{Set} \arrow[r, "{{\mathcal{P}}^{∗}}"] \arrow[r, "{\perp}"] \arrow[r, leftarrow, "{{{\mathcal{P}}^{∗}}^{\mathsf{op}}}"'] & {\mathbf{Set}}^{\mathsf{op}}
\end{tikzcd}
\end{center}
...
\begin{center}
\begin{tikzcd}
{} & {\mathsf{DA}}_{\mathcal{L}} \arrow[dl, "{R}"] \arrow[dr, "{O}"] & {} \\
{\mathsf{rDA}}_{\mathcal{L}} \arrow[ur, hook] \arrow[ur, "{\perp}"] \arrow[dr, "{⊤}"] \arrow[dr, "{O}"] & {} & {\mathsf{oDA}}_{\mathcal{L}} \arrow[ul, hook] \arrow[ul, "{⊤}"] \arrow[dl, "{\perp}"] \arrow[dl, "{R}"] \\
{} & {\mathsf{mDA}}_{\mathcal{L}} \arrow[ul, hook] \arrow[ur, hook] & {}
\end{tikzcd}
\end{center}
...
\begin{center}
\begin{tikzcd}
{} &  \arrow[dl, "{R}"] \arrow[dr, "{O}"] & {} & {} & {{\mathsf{DA}}_{\mathsf{rev}\left( \mathcal{L} \right)}}^{\mathsf{op}} \arrow[dl, "{{R}^{\mathsf{op}}}"] \arrow[dr, "{{O}^{\mathsf{op}}}"] & {} \\
{\mathsf{rDA}}_{\mathcal{L}} \arrow[ur, hook] \arrow[ur, "{\perp}"] \arrow[dr, "{⊤}"] \arrow[dr, "{O}"] \arrow[rrrrr, "{\overline{2}}"] & {} & {\mathsf{oDA}}_{\mathcal{L}} \arrow[ul, hook] \arrow[ul, "{⊤}"] \arrow[dl, "{\perp}"] \arrow[dl, "{R}"] & {{\mathsf{rDA}}_{\mathsf{rev}\left( \mathcal{L} \right)}}^{\mathsf{op}} \arrow[ur, hook] \arrow[ur, "{\perp}"] \arrow[dr, "{⊤}"] \arrow[dr, "{{O}^{\mathsf{op}}}"] & {} & {{\mathsf{oDA}}_{\mathsf{rev}\left( \mathcal{L} \right)}}^{\mathsf{op}} \arrow[ul, hook] \arrow[ul, "{⊤}"] \arrow[dl, "{\perp}"] \arrow[dl, "{{R}^{\mathsf{op}}}"] \\
{} &  \arrow[ul, hook] \arrow[ur, hook] & {} & {} & {{\mathsf{mDA}}_{\mathsf{rev}\left( \mathcal{L} \right)}}^{\mathsf{op}} \arrow[ul, hook] \arrow[ur, hook] \arrow[lll, "{{\overline{2}}^{\mathsf{op}}}"] & {}
\end{tikzcd}
\end{center}
