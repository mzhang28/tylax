...
\[
U\left( Q \right) \xrightarrow{{\mathcal{P}}^{∗}} U\left( {Q}^{'} \right)
\]
...
\begin{center}
\begin{tikzcd}
{\mathsf{DA}}_{\mathcal{L}} \arrow[r, bend left=15, "{\overline{2}}"] \arrow[r, draw=none, "{\perp}"] \arrow[r, bend right=15, "{{\overline{2}}^{\mathsf{op}}}"'] \arrow[d, "{U}"] & {{\mathsf{DA}}_{\mathsf{rev}\left( \mathcal{L} \right)}}^{\mathsf{op}} \arrow[d, "{U}"] \\
\mathbf{Set} \arrow[r, bend left=15, "{{\mathcal{P}}^{∗}}"] \arrow[r, draw=none, "{\perp}"] \arrow[r, leftarrow, bend right=15, "{{{\mathcal{P}}^{∗}}^{\mathsf{op}}}"'] & {\mathbf{Set}}^{\mathsf{op}}
\end{tikzcd}
\end{center}
...
{\mathsf{rDA}}_{\mathcal{L}} \arrow[ur, hook, bend left=30] \arrow[ur, draw=none, bend left=10, "{\perp}"] \arrow[dr, draw=none, bend right=10, "{⊤}"] \arrow[dr, bend right=30, "{O}"] & {} & {\mathsf{oDA}}_{\mathcal{L}} \arrow[ul, hook, bend right=30] \arrow[ul, draw=none, bend right=10, "{⊤}"] \arrow[dl, draw=none, bend left=10, "{\perp}"] \arrow[dl, bend left=30, "{R}"] \\
...
{\mathsf{rDA}}_{\mathcal{L}} \arrow[ur, hook, bend left=30] \arrow[ur, draw=none, bend left=10, "{\perp}"] \arrow[dr, draw=none, bend right=10, "{⊤}"] \arrow[dr, bend right=30, "{O}"] \arrow[rrrrr, bend left=5, "{\overline{2}}"] & {} & {\mathsf{oDA}}_{\mathcal{L}} \arrow[ul, hook, bend right=30] \arrow[ul, draw=none, bend right=10, "{⊤}"] \arrow[dl, draw=none, bend left=10, "{\perp}"] \arrow[dl, bend left=30, "{R}"] & {{\mathsf{rDA}}_{\mathsf{rev}\left( \mathcal{L} \right)}}^{\mathsf{op}} \arrow[ur, hook, bend left=30] \arrow[ur, draw=none, bend left=10, "{\perp}"] \arrow[dr, draw=none, bend right=10, "{⊤}"] \arrow[dr, bend right=30, "{{O}^{\mathsf{op}}}"] & {} & {{\mathsf{oDA}}_{\mathsf{rev}\left( \mathcal{L} \right)}}^{\mathsf{op}} \arrow[ul, hook, bend right=30] \arrow[ul, draw=none, bend right=10, "{⊤}"] \arrow[dl, draw=none, bend left=10, "{\perp}"] \arrow[dl, bend left=30, "{{R}^{\mathsf{op}}}"] \\
