...
\begin{itemize}
\item \ensuremath{f} commutes with the transition map, or in other words, for any \ensuremath{s \in \Sigma}, this square commutes: \texttt{[unsupported Typst element: context]}
